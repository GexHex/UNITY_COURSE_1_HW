...
namespace Assets._Project.Develop.Runtime.UI
{
    public class ProjectPresentersFactory
    {
        ...
        public StatPresenter CreateStatsPresenter(
           IconTextView view,
           ...
           StatsType type)
        {
            return new StatPresenter(
                stat,
                type,
                _container.Resolve<ConfigsProviderService>().GetConfig<StatsIconsConfig>(),
                view);
        }

        public StatsListPresenter CreateStatsListPresenter(IconTextListView view) // new
        {
            return new StatsListPresenter(
