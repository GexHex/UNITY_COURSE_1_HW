...
namespace Assets._Project.Develop.Runtime.Gameplay.Features.MovementFeature
{
    public class RigidbodyRotationSystem : IInitializableSystem, IUpdatableSystem
    {
        ...
        private bool _lookToTargetOnSpawn;
        ...
        public void OnUpdate(float deltaTime)
        {
            ...
            if (_lookToTargetOnSpawn == false)
            {
                _lookToTargetOnSpawn = true;

                _rigidbody.rotation = Quaternion.LookRotation(_direction.Value.normalized);
