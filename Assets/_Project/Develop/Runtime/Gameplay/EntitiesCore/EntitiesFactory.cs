...
using Assets._Project.Develop.Runtime.Gameplay.Features.InfoDisplay;
    ...
    public class EntitiesFactory
    {
        ...
        public Entity CreateHero(Vector3 position)
        {
            ...
            entity
                ...
                .AddIsMoving()
                .AddAttackProcessInitialTime(new ReactiveVariable<float>(0.2f))
                ...
                .AddAttackCooldownInitialTime(new ReactiveVariable<float>(0.1f))
                ...
                .AddTeleportRadius(new ReactiveVariable<float>(8f))
                .AddTeleportInterval(new ReactiveVariable<float>(1f))
            ...
            ICompositeCondition canTeleport = new CompositeCondition()
                .Add(new FuncCondition(() => entity.IsDead.Value == false))
                .Add(new FuncCondition(() => entity.InDeathProcess.Value == false))
                .Add(new FuncCondition(() => entity.Energy.Value >= entity.TeleportEnergyCost.Value));
