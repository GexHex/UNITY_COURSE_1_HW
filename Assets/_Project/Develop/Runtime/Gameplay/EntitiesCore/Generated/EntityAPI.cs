namespace Assets._Project.Develop.Runtime.Gameplay.EntitiesCore
{
	...
	{
		public Assets._Project.Develop.Runtime.Gameplay.Features.Teleport.RunTeleportEvent RunTeleportEventC => GetComponent<Assets._Project.Develop.Runtime.Gameplay.Features.Teleport.RunTeleportEvent>();

		public Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent<UnityEngine.Vector3> RunTeleportEvent => RunTeleportEventC.Value;

		public bool TryGetRunTeleportEvent(out Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent<UnityEngine.Vector3> value)
		{
			bool result = TryGetComponent(out Assets._Project.Develop.Runtime.Gameplay.Features.Teleport.RunTeleportEvent component);
			if(result)
		...
		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddRunTeleportEvent()
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.Teleport.RunTeleportEvent() { Value = new Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent<UnityEngine.Vector3>() }); 
		}

		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddRunTeleportEvent(Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent<UnityEngine.Vector3> value)
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.Teleport.RunTeleportEvent() {Value = value}); 
		}

		public Assets._Project.Develop.Runtime.Gameplay.Features.Teleport.CompletedTeleportEvent CompletedTeleportEventC => GetComponent<Assets._Project.Develop.Runtime.Gameplay.Features.Teleport.CompletedTeleportEvent>();

		public Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent CompletedTeleportEvent => CompletedTeleportEventC.Value;

		public bool TryGetCompletedTeleportEvent(out Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent value)
		{
			bool result = TryGetComponent(out Assets._Project.Develop.Runtime.Gameplay.Features.Teleport.CompletedTeleportEvent component);
			if(result)
				value = component.Value;
			else
		...
		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddCompletedTeleportEvent()
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.Teleport.CompletedTeleportEvent() { Value = new Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent() }); 
		}

		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddCompletedTeleportEvent(Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent value)
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.Teleport.CompletedTeleportEvent() {Value = value}); 
		}
		...
		public Assets._Project.Develop.Runtime.Gameplay.Features.Teleport.TeleportRadius TeleportRadiusC => GetComponent<Assets._Project.Develop.Runtime.Gameplay.Features.Teleport.TeleportRadius>();
		...
		{
			bool result = TryGetComponent(out Assets._Project.Develop.Runtime.Gameplay.Features.Teleport.TeleportRadius component);
			if(result)
				value = component.Value;
			else
		...
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.Teleport.TeleportRadius() { Value = new Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Single>() }); 
		}
		...
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.Teleport.TeleportRadius() {Value = value}); 
		}

		public Assets._Project.Develop.Runtime.Gameplay.Features.Teleport.TeleportInterval TeleportIntervalC => GetComponent<Assets._Project.Develop.Runtime.Gameplay.Features.Teleport.TeleportInterval>();

		public Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Single> TeleportInterval => TeleportIntervalC.Value;

		public bool TryGetTeleportInterval(out Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Single> value)
		{
			bool result = TryGetComponent(out Assets._Project.Develop.Runtime.Gameplay.Features.Teleport.TeleportInterval component);
			if(result)
				value = component.Value;
			else
				value = default(Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Single>);
		...
		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddTeleportInterval()
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.Teleport.TeleportInterval() { Value = new Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Single>() }); 
		}

		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddTeleportInterval(Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Single> value)
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.Teleport.TeleportInterval() {Value = value}); 
		}

		public Assets._Project.Develop.Runtime.Gameplay.Features.Teleport.TeleportEnergyCost TeleportEnergyCostC => GetComponent<Assets._Project.Develop.Runtime.Gameplay.Features.Teleport.TeleportEnergyCost>();

		public Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Int32> TeleportEnergyCost => TeleportEnergyCostC.Value;

		public bool TryGetTeleportEnergyCost(out Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Int32> value)
		{
			bool result = TryGetComponent(out Assets._Project.Develop.Runtime.Gameplay.Features.Teleport.TeleportEnergyCost component);
			if(result)
				value = component.Value;
			else
		...
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.Teleport.TeleportEnergyCost() { Value = new Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Int32>() }); 
		}

		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddTeleportEnergyCost(Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Int32> value)
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.Teleport.TeleportEnergyCost() {Value = value}); 
		}
		...
		public Assets._Project.Develop.Runtime.Gameplay.Features.Player.IsPlayer IsPlayerC => GetComponent<Assets._Project.Develop.Runtime.Gameplay.Features.Player.IsPlayer>();

		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddIsPlayer()
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.Player.IsPlayer() ); 
		}
		...
		public Assets._Project.Develop.Runtime.Gameplay.Features.InfoDisplay.InfoText InfoTextC => GetComponent<Assets._Project.Develop.Runtime.Gameplay.Features.InfoDisplay.InfoText>();

		public TMPro.TMP_Text InfoText => InfoTextC.Value;

		public bool TryGetInfoText(out TMPro.TMP_Text value)
		{
			bool result = TryGetComponent(out Assets._Project.Develop.Runtime.Gameplay.Features.InfoDisplay.InfoText component);
			if(result)
				value = component.Value;
			else
				value = default(TMPro.TMP_Text);
			return result;
		}

		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddInfoText(TMPro.TMP_Text value)
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.InfoDisplay.InfoText() {Value = value}); 
		}

		public Assets._Project.Develop.Runtime.Gameplay.Features.Energy.EnergyComponent EnergyC => GetComponent<Assets._Project.Develop.Runtime.Gameplay.Features.Energy.EnergyComponent>();

		public Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Int32> Energy => EnergyC.Value;

		public bool TryGetEnergy(out Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Int32> value)
		{
			bool result = TryGetComponent(out Assets._Project.Develop.Runtime.Gameplay.Features.Energy.EnergyComponent component);
			if(result)
				value = component.Value;
			else
				value = default(Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Int32>);
		...
		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddEnergy()
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.Energy.EnergyComponent() { Value = new Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Int32>() }); 
		}

		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddEnergy(Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Int32> value)
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.Energy.EnergyComponent() {Value = value}); 
		}

		public Assets._Project.Develop.Runtime.Gameplay.Features.Energy.FullOfEnergyEvent FullOfEnergyEventC => GetComponent<Assets._Project.Develop.Runtime.Gameplay.Features.Energy.FullOfEnergyEvent>();

		public Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent FullOfEnergyEvent => FullOfEnergyEventC.Value;

		public bool TryGetFullOfEnergyEvent(out Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent value)
		{
			bool result = TryGetComponent(out Assets._Project.Develop.Runtime.Gameplay.Features.Energy.FullOfEnergyEvent component);
			if(result)
				value = component.Value;
			else
				value = default(Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent);
		...
		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddFullOfEnergyEvent()
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.Energy.FullOfEnergyEvent() { Value = new Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent() }); 
		}

		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddFullOfEnergyEvent(Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent value)
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.Energy.FullOfEnergyEvent() {Value = value}); 
		}
		...
		public Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Int32> MaxEnergy => MaxEnergyC.Value;

		public bool TryGetMaxEnergy(out Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Int32> value)
		{
		...
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.Energy.MaxEnergy() { Value = new Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Int32>() }); 
		}

		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddMaxEnergy(Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Int32> value)
		{
		...
		public Assets._Project.Develop.Runtime.Gameplay.Features.AreaDamage.AreaDamageValue AreaDamageValueC => GetComponent<Assets._Project.Develop.Runtime.Gameplay.Features.AreaDamage.AreaDamageValue>();

		public Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Single> AreaDamageValue => AreaDamageValueC.Value;

		public bool TryGetAreaDamageValue(out Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Single> value)
		{
			bool result = TryGetComponent(out Assets._Project.Develop.Runtime.Gameplay.Features.AreaDamage.AreaDamageValue component);
			if(result)
				value = component.Value;
			else
				value = default(Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Single>);
		...
		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddAreaDamageValue()
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.AreaDamage.AreaDamageValue() { Value = new Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Single>() }); 
		}

		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddAreaDamageValue(Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Single> value)
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.AreaDamage.AreaDamageValue() {Value = value}); 
		}

		public Assets._Project.Develop.Runtime.Gameplay.Features.AreaDamage.AreaDamageRadius AreaDamageRadiusC => GetComponent<Assets._Project.Develop.Runtime.Gameplay.Features.AreaDamage.AreaDamageRadius>();

		public Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Single> AreaDamageRadius => AreaDamageRadiusC.Value;

		public bool TryGetAreaDamageRadius(out Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Single> value)
		{
			bool result = TryGetComponent(out Assets._Project.Develop.Runtime.Gameplay.Features.AreaDamage.AreaDamageRadius component);
			if(result)
				value = component.Value;
			else
				value = default(Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Single>);
		...
		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddAreaDamageRadius()
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.AreaDamage.AreaDamageRadius() { Value = new Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Single>() }); 
		}

		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddAreaDamageRadius(Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Single> value)
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.AreaDamage.AreaDamageRadius() {Value = value}); 
		}

		public Assets._Project.Develop.Runtime.Gameplay.Features.AreaDamage.AreaDamageTargetsMask AreaDamageTargetsMaskC => GetComponent<Assets._Project.Develop.Runtime.Gameplay.Features.AreaDamage.AreaDamageTargetsMask>();

		public UnityEngine.LayerMask AreaDamageTargetsMask => AreaDamageTargetsMaskC.Value;

		public bool TryGetAreaDamageTargetsMask(out UnityEngine.LayerMask value)
		{
			bool result = TryGetComponent(out Assets._Project.Develop.Runtime.Gameplay.Features.AreaDamage.AreaDamageTargetsMask component);
			if(result)
				value = component.Value;
			else
				value = default(UnityEngine.LayerMask);
		...
		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddAreaDamageTargetsMask(UnityEngine.LayerMask value)
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.AreaDamage.AreaDamageTargetsMask() {Value = value}); 
		}

		public Assets._Project.Develop.Runtime.Gameplay.Features.AreaDamage.AreaDamageCollidersBuffer AreaDamageCollidersBufferC => GetComponent<Assets._Project.Develop.Runtime.Gameplay.Features.AreaDamage.AreaDamageCollidersBuffer>();

		public Assets._Project.Develop.Runtime.Utilities.Buffer<UnityEngine.Collider> AreaDamageCollidersBuffer => AreaDamageCollidersBufferC.Value;

		public bool TryGetAreaDamageCollidersBuffer(out Assets._Project.Develop.Runtime.Utilities.Buffer<UnityEngine.Collider> value)
		{
			bool result = TryGetComponent(out Assets._Project.Develop.Runtime.Gameplay.Features.AreaDamage.AreaDamageCollidersBuffer component);
			if(result)
				value = component.Value;
			else
				value = default(Assets._Project.Develop.Runtime.Utilities.Buffer<UnityEngine.Collider>);
		...
		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddAreaDamageCollidersBuffer(Assets._Project.Develop.Runtime.Utilities.Buffer<UnityEngine.Collider> value)
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.AreaDamage.AreaDamageCollidersBuffer() {Value = value}); 
		}

		public Assets._Project.Develop.Runtime.Gameplay.Features.AreaDamage.RunAreaDamageEvent RunAreaDamageEventC => GetComponent<Assets._Project.Develop.Runtime.Gameplay.Features.AreaDamage.RunAreaDamageEvent>();

		public Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent RunAreaDamageEvent => RunAreaDamageEventC.Value;

		public bool TryGetRunAreaDamageEvent(out Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent value)
		{
			bool result = TryGetComponent(out Assets._Project.Develop.Runtime.Gameplay.Features.AreaDamage.RunAreaDamageEvent component);
			if(result)
				value = component.Value;
			else
				value = default(Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent);
		...
		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddRunAreaDamageEvent()
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.AreaDamage.RunAreaDamageEvent() { Value = new Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent() }); 
		}

		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddRunAreaDamageEvent(Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent value)
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.AreaDamage.RunAreaDamageEvent() {Value = value}); 
		}

		public Assets._Project.Develop.Runtime.Gameplay.Features.AreaDamage.CanRunAreaDamage CanRunAreaDamageC => GetComponent<Assets._Project.Develop.Runtime.Gameplay.Features.AreaDamage.CanRunAreaDamage>();

		public Assets._Project.Develop.Runtime.Utilities.Conditions.ICompositeCondition CanRunAreaDamage => CanRunAreaDamageC.Value;

		public bool TryGetCanRunAreaDamage(out Assets._Project.Develop.Runtime.Utilities.Conditions.ICompositeCondition value)
		{
			bool result = TryGetComponent(out Assets._Project.Develop.Runtime.Gameplay.Features.AreaDamage.CanRunAreaDamage component);
			if(result)
				value = component.Value;
			else
				value = default(Assets._Project.Develop.Runtime.Utilities.Conditions.ICompositeCondition);
		...
		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddCanRunAreaDamage(Assets._Project.Develop.Runtime.Utilities.Conditions.ICompositeCondition value)
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.AreaDamage.CanRunAreaDamage() {Value = value}); 
		}

		public Assets._Project.Develop.Runtime.Gameplay.Features.AreaDamage.AreaDamageTargetsBuffer AreaDamageTargetsBufferC => GetComponent<Assets._Project.Develop.Runtime.Gameplay.Features.AreaDamage.AreaDamageTargetsBuffer>();

		public Assets._Project.Develop.Runtime.Utilities.Buffer<Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity> AreaDamageTargetsBuffer => AreaDamageTargetsBufferC.Value;

		public bool TryGetAreaDamageTargetsBuffer(out Assets._Project.Develop.Runtime.Utilities.Buffer<Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity> value)
		{
			bool result = TryGetComponent(out Assets._Project.Develop.Runtime.Gameplay.Features.AreaDamage.AreaDamageTargetsBuffer component);
			if(result)
				value = component.Value;
			else
				value = default(Assets._Project.Develop.Runtime.Utilities.Buffer<Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity>);
		...
		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddAreaDamageTargetsBuffer(Assets._Project.Develop.Runtime.Utilities.Buffer<Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity> value)
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.AreaDamage.AreaDamageTargetsBuffer() {Value = value}); 
		}
