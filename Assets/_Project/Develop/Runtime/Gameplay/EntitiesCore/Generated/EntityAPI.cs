namespace Assets._Project.Develop.Runtime.Gameplay.EntitiesCore
{
	public partial class Entity
	{
		...
		public Assets._Project.Develop.Runtime.Gameplay.Features.PlayerInteraction.PlayerExplosionEvent PlayerExplosionEventC => GetComponent<Assets._Project.Develop.Runtime.Gameplay.Features.PlayerInteraction.PlayerExplosionEvent>();

		public Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent<UnityEngine.Vector3> PlayerExplosionEvent => PlayerExplosionEventC.Value;

		public bool TryGetPlayerExplosionEvent(out Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent<UnityEngine.Vector3> value)
		{
			bool result = TryGetComponent(out Assets._Project.Develop.Runtime.Gameplay.Features.PlayerInteraction.PlayerExplosionEvent component);
			if(result)
				value = component.Value;
			else
		...
		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddPlayerExplosionEvent()
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.PlayerInteraction.PlayerExplosionEvent() { Value = new Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent<UnityEngine.Vector3>() }); 
		}

		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddPlayerExplosionEvent(Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent<UnityEngine.Vector3> value)
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.PlayerInteraction.PlayerExplosionEvent() {Value = value}); 
		}

		public Assets._Project.Develop.Runtime.Gameplay.Features.PlayerInteraction.PlayerPointerMoveEvent PlayerPointerMoveEventC => GetComponent<Assets._Project.Develop.Runtime.Gameplay.Features.PlayerInteraction.PlayerPointerMoveEvent>();

		public Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent<Assets._Project.Develop.Runtime.Gameplay.Features.PlayerInteraction.PointerMoveArgs> PlayerPointerMoveEvent => PlayerPointerMoveEventC.Value;

		public bool TryGetPlayerPointerMoveEvent(out Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent<Assets._Project.Develop.Runtime.Gameplay.Features.PlayerInteraction.PointerMoveArgs> value)
		{
			bool result = TryGetComponent(out Assets._Project.Develop.Runtime.Gameplay.Features.PlayerInteraction.PlayerPointerMoveEvent component);
			if(result)
				value = component.Value;
			else
				value = default(Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent<Assets._Project.Develop.Runtime.Gameplay.Features.PlayerInteraction.PointerMoveArgs>);
			return result;
		}

		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddPlayerPointerMoveEvent()
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.PlayerInteraction.PlayerPointerMoveEvent() { Value = new Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent<Assets._Project.Develop.Runtime.Gameplay.Features.PlayerInteraction.PointerMoveArgs>() }); 
		}

		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddPlayerPointerMoveEvent(Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent<Assets._Project.Develop.Runtime.Gameplay.Features.PlayerInteraction.PointerMoveArgs> value)
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.PlayerInteraction.PlayerPointerMoveEvent() {Value = value}); 
		}
		...
		public Assets._Project.Develop.Runtime.Gameplay.Features.Mines.MineTriggeredEvent MineTriggeredEventC => GetComponent<Assets._Project.Develop.Runtime.Gameplay.Features.Mines.MineTriggeredEvent>();

		public Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent MineTriggeredEvent => MineTriggeredEventC.Value;

		public bool TryGetMineTriggeredEvent(out Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent value)
		{
			bool result = TryGetComponent(out Assets._Project.Develop.Runtime.Gameplay.Features.Mines.MineTriggeredEvent component);
			if(result)
				value = component.Value;
			else
		...
		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddMineTriggeredEvent()
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.Mines.MineTriggeredEvent() { Value = new Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent() }); 
		}

		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddMineTriggeredEvent(Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent value)
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.Mines.MineTriggeredEvent() {Value = value}); 
		}
		...
		public Assets._Project.Develop.Runtime.Gameplay.Features.Explosions.ExplosionRadius ExplosionRadiusC => GetComponent<Assets._Project.Develop.Runtime.Gameplay.Features.Explosions.ExplosionRadius>();
		...
		{
			bool result = TryGetComponent(out Assets._Project.Develop.Runtime.Gameplay.Features.Explosions.ExplosionRadius component);
			if(result)
				value = component.Value;
			else
				value = default(Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Single>);
		...
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.Explosions.ExplosionRadius() { Value = new Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Single>() }); 
		}
		...
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.Explosions.ExplosionRadius() {Value = value}); 
		}

		public Assets._Project.Develop.Runtime.Gameplay.Features.Explosions.ExplosionDamage ExplosionDamageC => GetComponent<Assets._Project.Develop.Runtime.Gameplay.Features.Explosions.ExplosionDamage>();
		...
		{
			bool result = TryGetComponent(out Assets._Project.Develop.Runtime.Gameplay.Features.Explosions.ExplosionDamage component);
			if(result)
				value = component.Value;
			else
				value = default(Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Single>);
		...
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.Explosions.ExplosionDamage() { Value = new Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Single>() }); 
		}
		...
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.Explosions.ExplosionDamage() {Value = value}); 
		}
		...
		public Assets._Project.Develop.Runtime.Gameplay.Features.BuildingFeature.IsBuilding IsBuildingC => GetComponent<Assets._Project.Develop.Runtime.Gameplay.Features.BuildingFeature.IsBuilding>();

		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddIsBuilding()
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.BuildingFeature.IsBuilding() ); 
		}
