...
namespace Assets._Project.Develop.Runtime.Utilities.ConfigsManagment
{
    public class ResourcesConfigsLoader : IConfigsLoader
    {
        ...
        private readonly Dictionary<Type, string> _configsResourcesPaths = new()
        {
            ...
            {typeof(LevelConfig),       "Configs/Meta/Level/LevelConfig" },
            {typeof(GameBalanceConfig), "Configs/Meta/Level/GameBalanceConfig" },
            {typeof(CurrencyIconsConfig), "Configs/Meta/Wallet/CurrencyIconsConfig" },
            {typeof(StatsIconsConfig), "Configs/Meta/Stats/StatsIconsConfig" }        
        };
