...
public class ControllerRandomPoints : Controller
{
    ...
    public ControllerRandomPoints(IDirectionalMovable movable, IDirectionalRotatable rotatable, NavMeshQueryFilter queryFilter)
    {
        _movable = movable;
    ...
    private void MoveToTarget()
    {
        ...
        {
            agent.SetMoveDirection(_currentEnemyTarget);
